...
!pgfortran linsm1.f90 support.o -o lsm6 -O3 -r8
...
real,parameter::vp1=1.5,vs1=0.5,rho=2200.,mu=vs1**2,lambda=vp1**2-2*vs1**2
...
subroutine trapz(dx, y, ny, integral)
	...
	real,intent(in)  :: dx  !! Function y(x)
    real   ,intent(out)           :: integral            !! Integral ?y(x)·dx
	integer::i
